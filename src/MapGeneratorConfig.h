...
// FR-2: the minimum map size the generator accepts. Rows/cols below
...
// defaults are the assignment's minimum map size (FR-2) with a typical
// wall density. rows/cols must meet the FR-2 minimum (kMinMapRows x
